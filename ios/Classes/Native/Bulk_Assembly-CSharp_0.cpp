...
extern String_t* _stringLiteral2431605282;
extern const uint32_t BallController_Update_m3327480371_MetadataUsageId;
...
extern "C"  void BallController_Update_m3327480371 (BallController_t2992829471 * __this, const RuntimeMethod* method)
{
	...
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_method (BallController_Update_m3327480371_MetadataUsageId);
		s_Il2CppMethodInitialized = true;
	}
	...
	memset(&V_2, 0, sizeof(V_2));
	{
		...
		(&V_0)->set_x_1(L_2);
		Vector3_t3722313464  L_3 = Input_get_acceleration_m2528400370(NULL /*static, unused*/, /*hidden argument*/NULL);
		V_2 = L_3;
		float L_4 = (&V_2)->get_y_2();
		(&V_0)->set_z_3(L_4);
		float L_5 = Vector3_get_sqrMagnitude_m1474274574((&V_0), /*hidden argument*/NULL);
...
IL_0046:
	{
		IL2CPP_RUNTIME_CLASS_INIT(Input_t1431474628_il2cpp_TypeInfo_var);
		int32_t L_6 = Input_get_touchCount_m3403849067(NULL /*static, unused*/, /*hidden argument*/NULL);
	...
	}
	{
		...
		Debug_Log_m4051431634(NULL /*static, unused*/, _stringLiteral2431605282, /*hidden argument*/NULL);
		Vector3_t3722313464 * L_7 = __this->get_address_of_moveDirection_4();
		L_7->set_y_2((20.0f));
	}

IL_006b:
	{
		Vector3_t3722313464 * L_8 = __this->get_address_of_moveDirection_4();
		...
		L_9->set_y_2(((float)il2cpp_codegen_subtract((float)L_10, (float)((float)il2cpp_codegen_multiply((float)(10.0f), (float)L_11)))));
		CharacterController_t1138636865 * L_12 = __this->get_controller_3();
		Vector3_t3722313464  L_13 = __this->get_moveDirection_4();
		...
		NullCheck(L_19);
		Transform_Translate_m1810197270(L_19, L_22, /*hidden argument*/NULL);
		return;
	}
}
#ifdef __clang__
